...
public class StoryPLayerDBHelper extends SQLiteOpenHelper {
    ...
    public StoryPLayerDBHelper(Context context) {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        try {
            ...
            db.execSQL("DROP TABLE IF EXISTS " + DownloadingTableHelper.TABLENAME);
            onCreate(db);
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    public static String sqlForDownload() {
        String sql = "CREATE TABLE " + DownloadingTableHelper.TABLENAME + " (" + DownloadingTableHelper.ID + " INTEGER NOT NULL PRIMARY KEY,"
                + DownloadingTableHelper.NAME + " INTEGER NOT NULL,"

                + DownloadingTableHelper.URL_IMAGE + " TEXT NOT NULL,"
                + DownloadingTableHelper.TIMESTAMP + " TEXT NOT NULL,"
                + DownloadingTableHelper.SIZE + " TEXT NOT NULL,"
                + DownloadingTableHelper.URL_SONG + " TEXT NOT NULL,"
                + DownloadingTableHelper.LENGTH + " INTEGER NOT NULL);";
        return sql;
    }
