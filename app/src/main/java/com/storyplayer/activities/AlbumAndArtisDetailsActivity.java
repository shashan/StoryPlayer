...
import com.storyplayer.observablelib.ObservableScrollView;
import com.storyplayer.observablelib.ObservableScrollViewCallbacks;
import com.storyplayer.observablelib.ScrollState;
import com.storyplayer.observablelib.ScrollUtils;
...
import com.storyplayer.uicomponent.ExpandableHeightListView;
...
public class AlbumAndArtisDetailsActivity extends AppCompatActivity implements View.OnClickListener, ObservableScrollViewCallbacks, Slider.OnValueChangedListener,
    ...
    public class AllSongsListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            try {
                audioDuration = StoryPlayerUtility.getAudioDuration(Long.parseLong(mDetail.getDuration()));
