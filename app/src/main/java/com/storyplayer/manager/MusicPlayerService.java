...
public class MusicPlayerService extends Service implements AudioManager.OnAudioFocusChangeListener, NotificationManager.NotificationCenterDelegate {
    ...
    private void createNotification(SongDetail mSongDetail) {
        try {
            ...
            Intent intent = new Intent(ApplicationStoryPlayer.applicationContext, StoryPlayerBaseActivity.class);
            intent.setAction("openplayer");
            intent.setFlags(32768);
            PendingIntent contentIntent = PendingIntent.getActivity(ApplicationStoryPlayer.applicationContext, 0, intent, 0);
            ...
            Bitmap albumArt = audioInfo != null ? audioInfo.getSmallCover(ApplicationStoryPlayer.applicationContext) : null;
            ...
            if (remoteControlClient != null) {
                ...
                if (audioInfo != null && audioInfo.getCover(ApplicationStoryPlayer.applicationContext) != null) {
                    metadataEditor.putBitmap(RemoteControlClient.MetadataEditor.BITMAP_KEY_ARTWORK,
                            audioInfo.getCover(ApplicationStoryPlayer.applicationContext));
                }
